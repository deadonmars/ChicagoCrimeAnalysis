...
% Auto-generated by MATLAB on 26-Apr-2018 12:33:33
...
predictorNames = {'IUCR', 'Description', 'LocationDescription', 'Arrest', 'Domestic', 'Beat', 'District', 'Ward', 'CommunityArea', 'FBICode'};
predictors = inputTable(:, predictorNames);
response = inputTable.PrimaryType;
isCategoricalPredictor = [false, true, true, true, true, false, false, false, false, false];
...
classificationEnsemble = fitcensemble(...
    ...
    'Learners', template, ...
    'LearnRate', 0.1, ...
    'ClassNames', categorical({'ARSON'; 'ASSAULT'; 'BATTERY'; 'BURGLARY'; 'CONCEALED CARRY LICENSE VIOLATION'; 'CRIM SEXUAL ASSAULT'; 'CRIMINAL DAMAGE'; 'CRIMINAL TRESPASS'; 'DECEPTIVE PRACTICE'; 'GAMBLING'; 'HOMICIDE'; 'HUMAN TRAFFICKING'; 'INTERFERENCE WITH PUBLIC OFFICER'; 'INTIMIDATION'; 'KIDNAPPING'; 'LIQUOR LAW VIOLATION'; 'MOTOR VEHICLE THEFT'; 'NARCOTICS'; 'OBSCENITY'; 'OFFENSE INVOLVING CHILDREN'; 'OTHER OFFENSE'; 'PROSTITUTION'; 'PUBLIC INDECENCY'; 'PUBLIC PEACE VIOLATION'; 'Primary Type'; 'ROBBERY'; 'SEX OFFENSE'; 'STALKING'; 'THEFT'; 'WEAPONS VIOLATION'; 'OTHER NARCOTIC VIOLATION'; 'NON - CRIMINAL'; 'NON-CRIMINAL'}, {'ARSON' 'ASSAULT' 'BATTERY' 'BURGLARY' 'CONCEALED CARRY LICENSE VIOLATION' 'CRIM SEXUAL ASSAULT' 'CRIMINAL DAMAGE' 'CRIMINAL TRESPASS' 'DECEPTIVE PRACTICE' 'GAMBLING' 'HOMICIDE' 'HUMAN TRAFFICKING' 'INTERFERENCE WITH PUBLIC OFFICER' 'INTIMIDATION' 'KIDNAPPING' 'LIQUOR LAW VIOLATION' 'MOTOR VEHICLE THEFT' 'NARCOTICS' 'OBSCENITY' 'OFFENSE INVOLVING CHILDREN' 'OTHER OFFENSE' 'PROSTITUTION' 'PUBLIC INDECENCY' 'PUBLIC PEACE VIOLATION' 'Primary Type' 'ROBBERY' 'SEX OFFENSE' 'STALKING' 'THEFT' 'WEAPONS VIOLATION' 'OTHER NARCOTIC VIOLATION' 'NON - CRIMINAL' 'NON-CRIMINAL'}));
...
trainedClassifier.RequiredVariables = {'IUCR', 'Description', 'LocationDescription', 'Arrest', 'Domestic', 'Beat', 'District', 'Ward', 'CommunityArea', 'FBICode'};
